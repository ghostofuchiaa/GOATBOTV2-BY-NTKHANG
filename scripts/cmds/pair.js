...
const fs = require("fs-extra");
  ...
  pairType2: async function ({ api, event, threadsData, usersData, args }) {
    ...
    return api.sendMessage({
      ...
      Looks like your destiny brought you together with ${name2}『❤️』
...
${namee} 💓+💓 ${name}`,
    ...
    pairType5: async function ({ api, event, threadsData, usersData, args }) {
      ...
      let Avatar2 = (await axios.get(`https://graph.facebook.com/${id}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { responseType: "arraybuffer" })
